...
class Program
{
    ...
    {
        private Dictionary<String, Boolean> lookup = new Dictionary<String, Boolean>();
    ...
    private Rectangle MakePartialRectangle(int l, int h, Rectangle rectangle)
    {
        ...
        for (int i = 0; i < groupList[l - 1].Count; i++)
        {
    ...
    {
        Program dict = new Program(GetListOfWords());
