...
class Program
{
	...
	public static char[] GetT9Chars(char digit)
	{
		...
		int dig = (int)(Char.GetNumericValue(digit) - Char.GetNumericValue('0'));
		return t9Letters[dig];
	}

	public static void GetValidWords(String number, int index, String prefix, HashSet<String> wordSet, List<String> results)
	{
	...
	public static List<String> GetValidT9Words(String number, HashSet<String> wordList)
	{
