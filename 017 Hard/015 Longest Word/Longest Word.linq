...
class Program
{
    ...
    public static Boolean CanBuildWord(String str, Boolean isOriginalWord, Dictionary<String, Boolean> map)
    {
    ...
    public static String[] CreateGiantArray()
    {
        ...
        //    int n = RandomIntInRange(0, 1000);
        //    String s = arr[i];
        //    for (int j = 0; j < n; j++) {
        //        int index = RandomIntInRange(0, i);
        //        s += arr[index];
        //    }
        //    list.Add(s);
        //    list.Add(arr[i]);
